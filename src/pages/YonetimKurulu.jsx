...
export default function YonetimKurulu() {
  ...
  return (
      <>
    <Helmet>
      <title>Yönetim Kurulu | S.S. Kocayayla Köyü Tarımsal Kalkınma Kooperatifi</title>
      <meta name="description" content="Kocayayla Kooperatifi yönetim kurulu üyeleri ve görevleri." />
    </Helmet>
